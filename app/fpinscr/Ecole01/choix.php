...
$sqll=' SELECT * FROM equivalent_niveau_ecole where id='.$rows['NIVS'];
        ...
        <div class="content-wrapper">
          ...
          <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card-body">
                  ...
                  <h2 class="text-center text-success" > <b> مدرسة التكوين المهني في التسيير  - الجزائر   </b> </h2 >  <h6 class="text-center" >     إكمالية هارون الرشيد - ساحة 1 ماي -  الجزائر         </h6 >

                  <p class="card-title mt-2"><h2 class="text-center" >Ecole de Formation Professionnelle en Gestion -ALGER  </h2><h6 class="text-center"> CEM Haroune Rachid Place du 1er Mai – Alger </h6 > <br> <br>
                  ...
                  <form  method="POST" action="ins_choix.php" onsubmit="<?php echo 'return valideForm('.$rows["NIVS"].');' ?>"  >
                    ...
                    <div class="row">
                     <?php
                      ...
                      $sqll=' SELECT * FROM equivalent_formation_ecole where niveau<='.$ro['niveau'];
                      ...
                      if ($ro['id']=='7')
                      $sqll=' SELECT * FROM equivalent_formation_ecole where id=3';
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  ...
  <input type="button" name='retour' class="btn btn-primary  " onclick="javascript:history.back()"  value="Retour">
    ...
    <div class="form-group ">
      <center>  <?php  print "<img src='".$path."backup/ecole01/inscription/photos/".$rows['PHOTO']."' width='100px' height='120px'>";?>    </center>                          
    </div>
