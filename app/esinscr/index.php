...
";?>
  ...
  <script type="text/javascript">
            ...
            function fetch_moyenne()
                    {
                    $.ajax({
                    type: 'post',
                    url: 'fetch_moyenne.php',
                    data: {
                    get_option:jQuery("#moyenne").val()
                    },
                    success: function (response) {
                      //document.getElementById("cadr").innerHTML=response;
                      //if (val<response) 
                      ...
                      if (r=="false") alert('    معدل المترشح ! لا يسمح لك بتسجيل في الثانوية');
                      console.log(r);
            ...
            function isEmailValid(email){
                    ...
                    jQuery("#lmoy").html('  <h3 class="text-danger ">&nbsp;   المعدل القبول </h3>');
            ...
            function testForm(s){
                    ...
                    if (s=="moyenne") if(jQuery('#nivs').val()=='1') fetch_moyenne(); 
...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
               <div class="card-body">
                  ...
                  <hr class="border-warning mb-4"><br>
                   ...
                   <?php if (isset($_GET['moyg'])) print "<p class='h3 text-danger text-center'>     معدل المترشح   لا يسمح لك بتسجيل في الثانوية ".$_GET['mo']." </p>";?>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-xl-1 col-lg-1"><label  id="mnomar">&nbsp; Champ Obligatoire</label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 text-right"><label class="text-right text-gray-100 h6" for="textarea"><h3>  اللقب </h3> </label></div>
                    
                
                    
                      <div class="col-xl-1 col-lg-1"><label id="mprenomar">&nbsp; Champ Obligatoire</label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 text-right"><label class="text-right text-gray-100 h6  " for="textarea"><h3>  الاسم </h3></label></div>
                    ...
                    <div class="row mb-4 mb-4">
                      ...
                      <div class="col-xl-1 col-lg-1 mb-1"><label class="text-gray-100 h6" for="textarea">Nom </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1"><label id="mnome">&nbsp; Champ Obligatoire</label></div>
                    
                 
                    
                      <div class="col-xl-1 col-lg-1 mb-1"><label class="text-gray-100 h6" for="textarea">Prénom </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1"><label id="mprenome">&nbsp; Champ Obligatoire</label></div>
                     ...
                     <div class="row mb-4">
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-right text-gray-100 h6" for="textarea"><h3>&nbsp; الجنس </h3> </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-right text-gray-100 h6" for="textarea"><h3>&nbsp;تاريخ الميلاد</h3> </label></div>
                  ...
                  <div class="row mb-4">
                    ...
                    <option value=''></option>
                      ...
                      <div class="col-xl-2 col-lg-1 mb-2 text-right"><label id='lcnais' class="text-gray-100 h6" for="textarea"><h3>&nbsp;بلدية الميلاد</h3>  </label><label id="autre" class="text-gray-100 h6" for="textarea"><h3> مكان الإزياد </h3></label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;ولاية الميلاد</h3> </label></div>
                  ...
                  <div class="row mb-4">
                      ...
                      <div class="col-xl-9 col-lg-9 mb-1"><input type="text" class="form-control form-control-sm keyboardInput " dir="rtl" name="adr" id="adr"  placeholder="Adresse..." value="<?php if (isset($_GET['adr'])) print $_GET['adr'];?>" onblur="testForm('adr')"></div>
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;العنوان</h3></label></div>
                 ...
                 <div class="row mb-4">
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"> <h3>&nbsp;البلدية </h3> </label></div>
                      ...
                      <div class="col-xl-3 col-lg-3 mb-1">
                        ...
                        ?>
                          ...
                          <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;الولاية </h3> </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"> <h3>&nbsp; هاتف المترشح </h3></label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 " for="textarea"><h3>&nbsp;هاتف الأب </h3></label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6 text-right" for="textarea"> <h3>&nbsp;الهاتف الثابت </h3></label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;العنوان الإلكتروني</h3></label></div>
                  ...
                  <div class="row mb-4">
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;المستوى الدراسي الحالي  </h3></label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label class="text-gray-100 h6" for="textarea"><h3>&nbsp;تأكيد العنوان الإلكتروني  </h3></label></div>
              ...
              <div class="row mb-4">
                      ...
                      <div class="col-xl-1 col-lg-1 mb-1"><input type="hidden" name="MAX_FILE_SIZE" value="41943040" />  
                      <label id="mfile2">&nbsp; Champ Obligatoire </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"> <label class="text-gray-100 h6 text-right" for="textarea"><h3>&nbsp;صورة المترشح </h3></label>    </div>
                    

                            
                      <div class="col-xl-1 col-lg-1 mb-1"><input type="hidden" name="MAX_FILE_SIZE" value="41943040" />  
                      <label id="mfile1">&nbsp; Champ Obligatoire </label></div>
                      ...
                      <div class="col-xl-2 col-lg-2 mb-1" text-right> <label class="text-gray-100 h6 text-right" for="textarea"><h3>&nbsp;كشف النقاط الاخير  </h3></label>   </div>
                   ...
                   <div class="row mb-4">
                      ...
                      <div class="col-xl-1 col-lg-1 mb-1"></div>
                      <div class="col-xl-3 col-lg-3 mb-1"></div>
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"></div>
                    
                            
                      <div class="col-xl-1 col-lg-1 mb-1 text-right"><label id="mmoyenne"> &nbsp; هذا المعدل لا يسمح لك بالتسجيل </label></div>
                      <div class="col-xl-3 col-lg-3 mb-1"><input type="text" maxlength="5" class="form-control form-control-sm" name="moyenne" id="moyenne"  placeholder="" value="<?php if (isset($_GET['moyenne'])) print $_GET['moyenne'];?>" onblur="testForm('moyenne')"    ></div>
                      <div class="col-xl-2 col-lg-2 mb-1 text-right"><label name="lmoy" id="lmoy"  class="text-gray-100 h6 text-right" for="textarea"> <h3>&nbsp; المعدل السنوي  </h3></label></div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <h3 class="modal-title  "> مؤسسة التعليم الثانوي - حي 350 مسكن الربوة الحمراء حسين داي  -الجزائر </h3 >
      ...
      <div class="modal-body">
        <div class="col-lg-12">
          <?php 	
		      ...
		      ?>
        <?php if (isset($_GET['moyg'])) print "<p class='h3 text-danger text-center'>     معدل المترشح   لا يسمح لك بتسجيل في الثانوية ".$_GET['mo']." </p>"; else print '<h4 class="text-danger text-right">         ملاحظة للمترشحين ذوي مستوى السنة الرابعة متوسط  : معدل ​​القبول الأدنى'.$cnag.'</h4><img src="images/formation.png" alt="" width="100%">';?>          
